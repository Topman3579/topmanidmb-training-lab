...
const tracks = [
  ...
  },
  {
    ...
    href: "#roadmap",
    status: "วางโครง",
    description: "เลือกเครื่องมือ AI ให้ตรงภารกิจ พร้อมข้อควรระวังด้านความถูกต้องและความลับ",
  },
  {
        ...
        <div className="grid gap-0 lg:grid-cols-[1fr_0.8fr]">
          <div className="p-7 sm:p-10">
            ...
            <p className="mt-5 max-w-3xl text-base leading-relaxed text-navy-700 sm:text-lg">
              ...
              Prompt Engineering, RAG, OSINT, Dashboard ไปจนถึง War Room และ Executive Brief
            </p>
          ...
          <div className="border-t border-navy-900/10 bg-gradient-to-br from-navy-900 to-navy-800 p-7 text-ivory-50 lg:border-l lg:border-t-0 sm:p-10">
            ...
            <Link href="/rag-knowledge-base/" className="mt-6 inline-flex rounded-xl bg-gold px-5 py-2.5 text-sm font-semibold text-navy-900 transition hover:bg-gold-light">
              ต่อด้วย RAG & Knowledge Base →
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="lab-card p-6 sm:p-8">
        <div className="mb-5">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-navy-700 sm:text-base">
            ใช้หน้านี้เป็นศูนย์กลางสำหรับต่อยอดบทเรียนใหม่ในอนาคต โดยเริ่มจาก AI Video, Prompt Engineering และ RAG
          </p>
        </div>
